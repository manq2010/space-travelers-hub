...
const missionSlice = createSlice({
  ...
  reducers: {
    ...
    showMoreDiscription: (state, action) => {
      state.missions = state.missions.map((mission) => (mission.mission_id !== action.payload
        ? mission : { ...mission, toogleShow: !mission.toogleShow }));
    },
  },
...
export const { joinMission, leaveMission, showMoreDiscription } = missionSlice.actions;
